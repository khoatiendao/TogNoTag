...
<body>
    <div class="box_login">
        <div class="left_sign_in">
            ...
            <div class="icon_conn">
                <a class="icon_sign_in" href="https://www.instagram.com/tognotag/"><i class="ti-instagram"></i></a>
                <a class="icon_sign_in" href="https://www.facebook.com/doxuatkhauxuatdu"><i class="ti-facebook"></i></a>
            </div>

            <form action="Login.php" method="post">
                <div class="text_email" style="margin-top: 20px;">
                    <input class="input_email" type="text" placeholder="Email" name="email" require>
                </div>
                <div class="text_password">
                    <input class="input_password" type="password" placeholder="Password" name="password" require>
