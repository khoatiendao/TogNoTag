    ...
    <div class="CONTAINER">
        ...
        <div class="body3">
            <div class="box4-body3">
                ...
                <p class="gia">90.000 <sup>đ</sup></p>
            </div>

            <div class="box4-body3">
            <img src="./img/Quan-09.jpg" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
            ...
            <div class="box4-body3">
                <img src="./img/Quan-10.jpg" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
            ...
            <div class="box4-body3">
                <img src="./img/Quan-04.jpg" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
                ...
                <h2 class="box-motasp">Quần </h2>
                <p class="gia">70.000 <sup>đ</sup></p>
            </div>
        </div>
