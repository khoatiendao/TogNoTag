...
<body>
    ...
    <div class="CONTAINER">
        ...
        <div class="body2">
            <div class="box1-body2">
                <img src="./img/1-ao.png" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
                </ul>
                <h2 class="box-motasp">Áo thun </h2>
                <p class="gia">50.000 <sup>đ</sup></p>
            </div>

            <div class="box2-body2">
                <img src="./img/3-swt.jpg" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
                </ul>
                <h2 class="box-motasp">Áo Sweater </h2>
                <p class="gia">150.000 <sup>đ</sup></p>
            </div>


            <div class="box3-body2">
                ...
                <p class="gia">80.000 <sup>đ</sup></p>
            </div>


            <div class="box4-body2">
                <img src="./img/1-aokhoac.jpg" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
        ...
        <div class="body3">
            <div class="box1-body3">
                <img src="./img/6-ao.png" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
            ...
            <div class="box3-body3">
                <img src="./img/Hoodie-02.jpg" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
                </ul>
                <h2 class="box-motasp">Áo Hoodie </h2>
                <p class="gia">120.000 <sup>đ</sup></p>
            </div>

            <div class="box4-body3">
                <img src="./img/Quan-03.jpg" class="hinh-pho" alt="">
                <ul class="nut-sp">
                    <li class="box-nutsp"><a href="">Mua hàng</a></li>
                    <li class="box-nutsp"><a href="">Giỏ hàng</a></li>
                    <li class="box-nutsp"><a href="">Chi tiết</a></li>
                </ul>
                <h2 class="box-motasp">Quần </h2>
                <p class="gia">50.000 <sup>đ</sup></p>
            </div>
        </div>
            ...
            <div class="container-2">
                ...
                <div class="column" style="padding-left:100px ;">
                    ...
                    <ul style="margin-top: 10px">
                        ...
                        <li>
                            <a href="./html/DTH.html" class="ef">Chính sách đổi trả hàng</a>
                        </li>
                        <li>
